...
const baseLinks = computed(() => [
  ...
  { path: '/tickets', label: strings.value.routeTitles.tickets, permission: 'ticket:view' },
  { path: '/marketing', label: strings.value.routeTitles.marketing, permission: 'marketing:view' },
  { path: '/analytics', label: strings.value.routeTitles.analytics, permission: 'analytics:view' },
