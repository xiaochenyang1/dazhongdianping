  ...
  routes: [
    ...
    { path: '/settlement', component: () => import('@/views/SettlementView.vue'), meta: { requiresAuth: true, titleKey: 'settlement' } },
    {
      ...
      children: [
        ...
        { path: 'tickets', component: () => import('@/views/TicketsView.vue'), meta: { requiresAuth: true, titleKey: 'tickets' } },
        { path: 'marketing', component: () => import('@/views/MarketingView.vue'), meta: { requiresAuth: true, titleKey: 'marketing' } },
        { path: 'analytics', component: () => import('@/views/AnalyticsView.vue'), meta: { requiresAuth: true, titleKey: 'analytics' } },
        ...
        { path: 'waitlist', component: () => import('@/views/WaitlistView.vue'), meta: { requiresAuth: true, titleKey: 'waitlist' } },
