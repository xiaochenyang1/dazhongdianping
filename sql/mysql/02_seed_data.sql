...
INSERT INTO `admin_role` (`id`, `code`, `name`, `description`, `status`, `built_in`) VALUES
  ...
  (3, 'merchant_auditor', '商户审核员', '审核商户资质、团购、门店变更和认证商户', 1, 1),
  (4, 'operations_manager', '运营管理员', '维护 Banner、热词、运营活动、榜单、成长、圈子和话题', 1, 1),
...
INSERT INTO `hot_keyword` (`region`, `keyword`, `sort`, `enabled`) VALUES
  ('CN', '火锅', 0, 1),
  ('CN', '咖啡', 1, 1),
  ('EU', 'Cafe', 0, 1),
  ('EU', 'Chinese', 1, 1);
...
INSERT INTO `operation_activity_item` (
  ...
  (
    ...
    1,
    JSON_OBJECT('badge', '热门', 'trackCode', 'eu_school_shop_20001'),
    1
  ),
  (
    ...
    2,
    JSON_OBJECT('badge', '折扣', 'trackCode', 'eu_school_deal_41001'),
    1
  ),
  (
    ...
    3,
    JSON_OBJECT('trackCode', 'eu_school_rank_31001'),
    1
  ),
  (
    ...
    1,
    JSON_OBJECT('url', 'https://promo.example.com/cn/night-owl', 'badge', '说明'),
    1
  );
...
INSERT INTO points_product (region, name, cover_image, description, points_price, stock, exchange_limit_per_user, exchange_count, fulfill_type, status, sort, is_deleted) VALUES
  ('CN', '10 元到店代金券', 'https://cdn.example.com/points/cn-voucher-10.png', '全场通用，到店消费出示即可抵扣 10 元', 100, 500, 2, 0, 1, 1, 1, 0),
  ('CN', '下午茶 5 折券', 'https://cdn.example.com/points/cn-tea-half.png', '合作下午茶门店消费 5 折，单次最高减 30 元', 200, 300, 1, 0, 1, 1, 2, 0),
  ('CN', '周末会员周卡', 'https://cdn.example.com/points/cn-week-pass.png', '一周内门店订座与团购免排队特权', 500, 100, 1, 0, 2, 1, 3, 0),
  ('EU', '€2 Dining Voucher', 'https://cdn.example.com/points/eu-voucher-2.png', 'Valid at all partner restaurants, €2 off per bill', 150, 500, 2, 0, 1, 1, 1, 0),
  ('EU', 'Afternoon Tea 50% Off', 'https://cdn.example.com/points/eu-tea-half.png', 'Half price afternoon tea, up to €4 off', 250, 300, 1, 0, 1, 1, 2, 0),
  ('EU', 'Member Week Pass', 'https://cdn.example.com/points/eu-week-pass.png', 'Priority booking and queue skip for one week', 600, 100, 1, 0, 2, 1, 3, 0);
