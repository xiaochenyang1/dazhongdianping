...
DROP TABLE IF EXISTS `admin_shop_scope`;
...
CREATE TABLE `payment` (`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,`order_id` BIGINT UNSIGNED NOT NULL,`order_no` VARCHAR(32) NOT NULL,`channel` VARCHAR(16) NOT NULL,`channel_txn` VARCHAR(64) NOT NULL DEFAULT '',`client_secret` VARCHAR(255) NOT NULL DEFAULT '',`amount` DECIMAL(10,2) NOT NULL,`currency` CHAR(3) NOT NULL,`status` TINYINT NOT NULL DEFAULT 0,`raw_response` TEXT,`created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,`updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,PRIMARY KEY(`id`),UNIQUE KEY `uk_payment_channel_txn`(`channel`,`channel_txn`),KEY `idx_payment_order`(`order_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `coupon` (`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,`order_id` BIGINT UNSIGNED NOT NULL,`user_id` BIGINT UNSIGNED NOT NULL,`deal_id` BIGINT UNSIGNED NOT NULL,`shop_id` BIGINT UNSIGNED NOT NULL,`code` VARCHAR(32) NOT NULL,`status` TINYINT NOT NULL DEFAULT 1,`verify_at` DATETIME DEFAULT NULL,`verify_by` BIGINT UNSIGNED NOT NULL DEFAULT 0,`expire_at` DATE DEFAULT NULL,`remind_status` TINYINT NOT NULL DEFAULT 0 COMMENT '位标记: bit0=到期前3天已提醒, bit1=到期前1天/当天已提醒',`created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY(`id`),UNIQUE KEY `uk_coupon_code`(`code`),KEY `idx_coupon_user_status`(`user_id`,`status`),KEY `idx_coupon_expire_status`(`status`,`expire_at`,`id`),KEY `idx_coupon_remind`(`status`,`remind_status`,`expire_at`,`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `refund` (`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,`order_id` BIGINT UNSIGNED NOT NULL,`coupon_id` BIGINT UNSIGNED NOT NULL DEFAULT 0,`amount` DECIMAL(10,2) NOT NULL,`reason` VARCHAR(255) NOT NULL DEFAULT '',`status` TINYINT NOT NULL DEFAULT 0,`audit_by` BIGINT UNSIGNED NOT NULL DEFAULT 0,`audit_reason` VARCHAR(255) NOT NULL DEFAULT '',`channel` VARCHAR(32) NOT NULL DEFAULT '',`channel_refund_txn` VARCHAR(128) NOT NULL DEFAULT '',`channel_status` VARCHAR(32) NOT NULL DEFAULT '',`channel_failure_reason` VARCHAR(255) NOT NULL DEFAULT '',`audited_at` DATETIME DEFAULT NULL,`created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,`updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,PRIMARY KEY(`id`),UNIQUE KEY `uk_refund_order`(`order_id`),KEY `idx_refund_channel_txn`(`channel`,`channel_refund_txn`),KEY `idx_refund_processing`(`status`,`updated_at`,`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `channel_statement_batch` (`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,`admin_id` BIGINT UNSIGNED NOT NULL,`region` VARCHAR(8) NOT NULL,`channel` VARCHAR(32) NOT NULL,`file_name` VARCHAR(255) NOT NULL,`file_sha256` CHAR(64) NOT NULL,`total_rows` INT UNSIGNED NOT NULL DEFAULT 0,`matched_rows` INT UNSIGNED NOT NULL DEFAULT 0,`discrepancy_rows` INT UNSIGNED NOT NULL DEFAULT 0,`unmatched_rows` INT UNSIGNED NOT NULL DEFAULT 0,`invalid_rows` INT UNSIGNED NOT NULL DEFAULT 0,`ignored_rows` INT UNSIGNED NOT NULL DEFAULT 0,`status` TINYINT NOT NULL DEFAULT 0,`created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,`updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,PRIMARY KEY(`id`),UNIQUE KEY `uk_channel_statement_file`(`region`,`channel`,`file_sha256`),KEY `idx_channel_statement_batch_region`(`region`,`created_at`,`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `channel_statement_item` (`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,`batch_id` BIGINT UNSIGNED NOT NULL,`line_no` INT UNSIGNED NOT NULL,`transaction_type` VARCHAR(32) NOT NULL DEFAULT '',`channel_transaction_id` VARCHAR(128) NOT NULL DEFAULT '',`amount` DECIMAL(12,2) DEFAULT NULL,`currency` CHAR(3) NOT NULL DEFAULT '',`channel_status` VARCHAR(32) NOT NULL DEFAULT '',`occurred_at` VARCHAR(64) NOT NULL DEFAULT '',`order_no` VARCHAR(32) NOT NULL DEFAULT '',`local_biz_type` VARCHAR(16) NOT NULL DEFAULT '',`local_biz_id` BIGINT UNSIGNED NOT NULL DEFAULT 0,`local_amount` DECIMAL(12,2) DEFAULT NULL,`local_currency` CHAR(3) NOT NULL DEFAULT '',`local_status` TINYINT DEFAULT NULL,`reconcile_status` VARCHAR(16) NOT NULL,`discrepancy_reason` VARCHAR(255) NOT NULL DEFAULT '',`raw_data` JSON DEFAULT NULL,`created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY(`id`),KEY `idx_channel_statement_item_batch`(`batch_id`,`reconcile_status`,`line_no`,`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
