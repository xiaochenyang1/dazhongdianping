...
const zhCnStrings: WebStrings = {
  ...
  nav: [
    ...
    { to: '/guides', label: '攻略', matchPrefix: '/guides' },
    { to: '/marketing/seckill', label: '秒杀', matchPrefix: '/marketing' },
    ...
    { to: '/user/invoices', label: '发票', matchPrefix: '/user/invoices' },
    { to: '/user/tickets', label: '客服', matchPrefix: '/user/tickets' },
    { to: '/user/creator', label: '创作者', matchPrefix: '/user/creator' },
...
const enStrings: WebStrings = {
  ...
  nav: [
    ...
    { to: '/guides', label: 'Guides', matchPrefix: '/guides' },
    { to: '/marketing/seckill', label: 'Flash sale', matchPrefix: '/marketing' },
    ...
    { to: '/user/invoices', label: 'Invoices', matchPrefix: '/user/invoices' },
    { to: '/user/tickets', label: 'Support', matchPrefix: '/user/tickets' },
    { to: '/user/creator', label: 'Creator', matchPrefix: '/user/creator' },
