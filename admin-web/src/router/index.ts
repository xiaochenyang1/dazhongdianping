  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'operations/guides', name: 'guides', component: () => import('@/views/GuidesAdminView.vue'), meta: { requiresAuth: true, titleKey: 'guides', requiredPermission: 'operations:guide:read' } },
        { path: 'operations/creator', name: 'creator-tasks', component: () => import('@/views/CreatorAdminView.vue'), meta: { requiresAuth: true, titleKey: 'creatorTasks', requiredPermission: 'operations:creator:read' } },
        { path: 'operations/experiments', name: 'experiments', component: () => import('@/views/ExperimentsAdminView.vue'), meta: { requiresAuth: true, titleKey: 'experiments', requiredPermission: 'operations:experiment:read' } },
        { path: 'operations/campaign-audit', name: 'campaign-audit', component: () => import('@/views/CampaignAuditView.vue'), meta: { requiresAuth: true, titleKey: 'campaignAudit', requiredPermission: 'operations:marketing:read' } },
        { path: 'data/invoices', name: 'invoices', component: () => import('@/views/InvoicesAdminView.vue'), meta: { requiresAuth: true, titleKey: 'invoices', requiredPermission: 'finance:invoice:read' } },
        ...
        { path: 'audit/automod', name: 'automod-hits', component: () => import('@/views/AutomodHitsView.vue'), meta: { requiresAuth: true, titleKey: 'automod', requiredPermission: 'audit:automod:read' } },
        { path: 'support/tickets', name: 'support-tickets', component: () => import('@/views/SupportTicketsView.vue'), meta: { requiresAuth: true, titleKey: 'supportTickets', requiredPermission: 'support:ticket:read' } },
        {
          path: 'system/admins',
          name: 'system-admins',
        ...
        { path: 'system/openapi', name: 'openapi', component: () => import('@/views/OpenApiAppsView.vue'), meta: { requiresAuth: true, titleKey: 'openapi', requiredPermission: 'openapi:read' } },
      ],
    },
  ],
  scrollBehavior() {
