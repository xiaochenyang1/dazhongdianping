...
| 商户端与管理端完整闭环 | 部分完成 | `merchant-web` 已有注册、登录、资质、看板、门店草稿编辑/提交审核、员工、预订、团购创建/编辑/上下架、退款、券码核销和点评页面；管理端已有数据库 RBAC、Banner、搜索热词、运营活动、分类/城市/商圈、订单退款查询/平台仲裁/对账补偿、商户资质/点评/申诉/帖子/门店草稿审核、门店、榜单、成长、圈子和话题治理，审计日志、隐私任务查询，以及 C 端用户治理（查询/详情/封禁/解封，封禁即时吊销登录态、拦截密码与验证码登录并写审计日志）和用户封禁申诉闭环（免登录提交/查询申诉、`/audit/user-appeals` 审核页、通过自动解封、直接解封自动了结待审申诉、Web 登录弹层申诉入口） | 管理端团购审核仍无独立专页；真实支付渠道原路退款未接 | 已完成的 B/Admin 页面、权限、区域范围、角色实时收权、账号停用 `401`、审计日志/隐私任务/订单退款查询与仲裁补偿、基础数据、用户治理和封禁申诉真实后端 E2E 通过；其余经营深度与第三方集成另行验收 |
