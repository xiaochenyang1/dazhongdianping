          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(strings.topicFollowerCount(topic.followerCount)),
                const SizedBox(height: 14),
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    label: Text(
                      topic.followed ? strings.followed : strings.followTopic,
                    ),
                  ),
                ),
              ],
                ...
                return Column(
                  ...
                  children: [
                    ...
                    FilledButton.tonalIcon(
                      ...
                      label: Text(
                        reloading ? strings.processing : strings.retry,
                      ),
                    ),
                  ],
                );
              ...
              if (page.items.isEmpty) {
                return Card(
                  child: Padding(
                    ...
                    child: Text(strings.noPublicPostsHere),
                  ),
                );
              }
              return Column(
                children: [
                  ...
                  if (page.hasMore)
                    OutlinedButton.icon(
                      ...
                      label: Text(
                        loadingMore ? strings.loading : strings.loadMore,
                      ),
                    ),
                ],
              );
